...
from real.utilities import motion_util, pose3d
  ...
  """
    ...
    """
        ...
        with open(motion_file, "r") as f:
            ...
            assert (self._frame_duration >
                    0), "Frame duration must be positive."
    ...
    """
        out_frame[self.VEL_SIZE:(self.VEL_SIZE +
                                 self.ANG_VEL_SIZE)] = root_ang_vel
        return
